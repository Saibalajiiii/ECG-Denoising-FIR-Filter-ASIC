...
#
#
write_verilog ./results/filter_64.routed.v
write_sdc -output ./results/filter_64.routed.sdc
write_parasitics -format spef -output ./results/filter_64_${scenario1}.spef
#
