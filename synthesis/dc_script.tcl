...
#
set PDK_PATH ./../ref
set DESIGN_NAME                   "filter_64"
#
source -echo -verbose ./rm_setup/dc_setup.tcl
set RTL_SOURCE_FILES ./../rtl/filter_64.v
...
read_sdc -echo ./../CONSTRAINTS/filter_64.sdc

#compile

compile_ultra
#report_timing
report_area -hierarchy > results/filter_64_area.rpt
report_timing -path full > results/filter_64_timing.rpt
report_power > results/filter_64_power.rpt
#
### To write results
